  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        display: ["Syne", "Inter", "system-ui", "-apple-system", "BlinkMacSystemFont", "Segoe UI", "sans-serif"],
      ...
      fontSize: {
        ...
        "hero-xl": ["8rem", { lineHeight: "1.0", letterSpacing: "-0.04em", fontWeight: "800" }],
        "hero-lg": ["6rem", { lineHeight: "1.05", letterSpacing: "-0.04em", fontWeight: "800" }],
        "hero-md": ["4.5rem", { lineHeight: "1.05", letterSpacing: "-0.03em", fontWeight: "800" }],
      ...
      boxShadow: {
        "glass": "0 8px 32px rgba(0, 0, 0, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.1), inset 0 -1px 0 rgba(0, 0, 0, 0.2)",
        "glass-hover": "0 12px 40px rgba(0, 0, 0, 0.5), inset 0 2px 0 rgba(255, 255, 255, 0.14), inset 0 -1px 0 rgba(0, 0, 0, 0.25)",
      ...
      animation: {
        ...
        "gradient-drift": "gradient-drift 6s infinite alternate",
      ...
      keyframes: {
        ...
        breathe: { "0%, 100%": { transform: "scale(1)" }, "50%": { transform: "scale(1.005)" } },
        "gradient-drift": { "0%": { backgroundPosition: "0% 50%" }, "100%": { backgroundPosition: "100% 50%" } },
        "pulse-glow": { "0%, 100%": { opacity: "0.6", transform: "scale(1)" }, "50%": { opacity: "1", transform: "scale(1.02)" } },
        "border-rotate": { from: { "--border-angle": "0deg" }, to: { "--border-angle": "360deg" } },
      },
